...
class TemplateNameParserTest extends TestCase
{
    ...
    {
        return array(
            array('FooBundle:Post:_index.html.php', 'FooBundle:Post:_index.html.php', '@FooBundle/Resources/views/Post/_index.html.php', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'php')),
            array('FooBundle:Post:_index.html.twig', 'FooBundle:Post:_index.html.twig', '@FooBundle/Resources/views/Post/_index.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
            ...
            array('SensioFooBundle:Post:_index.html.php', 'SensioFooBundle:Post:_index.html.php', '@SensioFooBundle/Resources/views/Post/_index.html.php', new TemplateReference('SensioFooBundle', 'Post', 'index', 'html', 'php')),
            array('SensioCmsFooBundle:Post:_index.html.php', 'SensioCmsFooBundle:Post:_index.html.php', '@SensioCmsFooBundle/Resources/views/Post/_index.html.php', new TemplateReference('SensioCmsFooBundle', 'Post', 'index', 'html', 'php')),
            array(':Post:_index.html.php', ':Post:_index.html.php', 'views/Post/_index.html.php', new TemplateReference('', 'Post', 'index', 'html', 'php')),
            array('::_index.html.php', '::_index.html.php', 'views/_index.html.php', new TemplateReference('', '', 'index', 'html', 'php')),
            array('_index.html.php', '::_index.html.php', 'views/_index.html.php', new TemplateReference('', '', 'index', 'html', 'php')),
            array('FooBundle:Post:foo.bar._index.html.php', 'FooBundle:Post:foo.bar._index.html.php', '@FooBundle/Resources/views/Post/foo.bar._index.html.php', new TemplateReference('FooBundle', 'Post', 'foo.bar.index', 'html', 'php')),
            ...
            array('/path/to/section/_index.html.php', '/path/to/section/_index.html.php', '/path/to/section/_index.html.php', new BaseTemplateReference('/path/to/section/_index.html.php', 'php')),
            ...
            array('default/_index.html.php', '::default/_index.html.php', 'views/default/_index.html.php', new TemplateReference(null, null, 'default/index', 'html', 'php')),
        );
    }
    ...
    {
        $this->parser->parse('BarBundle:Post:_index.html.php');
    }
}
